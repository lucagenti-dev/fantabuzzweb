...
## Aggiornamento QR e grafica

Il QR viene ora generato direttamente dal server e non dipende più da CDN esterni. La palette principale è blu.


## Listone calciatori 2025/26
Il pannello banditore contiene ricerca, filtri per ruolo, nome e squadra e importazione CSV. Formato: Nome,Squadra,Ruolo. Ruoli ammessi: P, D, C, A.


## Dati inclusi

Sono inclusi 532 calciatori della stagione 2025/26, suddivisi in P, D, C e A, con nome, squadra, quotazione e FVM. Le foto sono state rimosse.
